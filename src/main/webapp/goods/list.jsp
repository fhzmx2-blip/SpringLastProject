	...
	<div class="container">
		<div class="row">
			<c:forEach var="vo" items="${list }">
				<div class="col-sm-3">
					<div class="thumbnail">
						<a href="../goods/detail_before.do?no=${vo.no }"> <img src="${vo.goods_poster }" title="${vo.goods_sub}"
			...
			<ul class="pagination">
				...
				<c:forEach var="i" begin="${startPage }" end="${endPage }">
					<li class="${i == curpage ? 'active' : ''}">
						<a href="../goods/main.do?page=${i }">${i }</a></li>
				</c:forEach>
    		...
    		<c:forEach var="cvo" items="${cList }">
    			<div style="width:100px;height:100px;display:inline-block">
    				<a href="../goods/detail_before.do?no=${cvo.no }">
    					<img src="${cvo.goods_poster }" title="${cvo.goods_name }" style="width:100%">
    				</a>
    			</div>
    		</c:forEach>
    	</c:if>
